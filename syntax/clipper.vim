...
syn match  clipperUserVariable  "\<\([a,b,c,d,h,l,n,o,u,x][A-Z]\|s_[A-Za-z0-9_]\)[A-Za-z0-9_]*\>"
...
" Define
syn match  clipperDefine       "^\s*#\s*define\>\s*"

syn match  clipperTranslate    "^\s*#\s*xtranslate\>\s*"
...
hi def link clipperDefine               PreProc
hi def link clipperTranslate            PreProc
